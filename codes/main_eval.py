...
MODEL_LOAD_NAME = "2020-03-27T22:06_test"
...
def main():
    ...
    evaluate_model(model, dataset=datasets["val"], idxs=EVALUATION_IDXS, scaler=scaler_dict["winning_bid"], save_path=model_load_path)
